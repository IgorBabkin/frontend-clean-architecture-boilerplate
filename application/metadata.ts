import { InjectMetadataCollector, MethodsMetadataCollector, ProvidersMetadataCollector } from 'ts-ioc-container';
...
export const providersMetadataCollector = ProvidersMetadataCollector.create();
